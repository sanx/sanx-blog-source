...
#ls $SOURCE_REPO_DIR/sanx.github.io.travis || { echo "ssh private key ('$SOURCE_REPO_DIR/sanx.github.io.travis') not found!"; }
#printf "Host github.com \n IdentityFile $SOURCE_REPO_DIR/sanx.github.io.travis\n" >> ~/.ssh/config || { echo "failed to write to ~/.ssh/config"; exit 1; }
#export GIT_SSH_COMMAND="ssh -i $SOURCE_REPO_DIR/sanx.github.io.travis -F /dev/null"
